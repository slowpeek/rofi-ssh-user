...
Put the script (make sure it has execute permission) into =$PATH=, for example:
...
Set some keyboard shortcut for the script/application by means of your desktop.
